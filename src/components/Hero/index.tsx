      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          ...
          >
            ...
            <div className="mx-auto mt-6 max-w-[500px] rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
              <h3 className="mb-6 text-2xl font-semibold text-black dark:text-white">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <a
                    href="mailto:info@cyphernxt.com"
                    aria-label="Email us at info@cyphernxt.com"
                    className="text-base text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  >
                    ops@cyphernxtlabs.com
                  </a>
                </div>
                {/* <div className="flex items-start">
                  ...
                  <address
                    ...
                    aria-label="Our address at 123 Tech Street, San Francisco, CA 94105"
                  >
                    123 Tech Street<br />
